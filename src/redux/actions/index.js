...
export const JwtActions = {
   VERIFY_TOKEN_SUCCESS_USER: 'VERIFY_TOKEN_SUCCESS_USER',
   VERIFY_TOKEN_FAILURE_USER: 'VERIFY_TOKEN_FAILURE_USER',
   VERIFY_TOKEN_SUCCESS_CART: 'VERIFY_TOKEN_SUCCESS_CART',
   VERIFY_TOKEN_FAILURE_CART: 'VERIFY_TOKEN_SUCCESS_CART'
}
