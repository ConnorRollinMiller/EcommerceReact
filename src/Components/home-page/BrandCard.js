...
const BrandCard = ({ ...props }) => (
	<div className='col-10 col-sm-4 p-2 d-flex justify-content-stretch align-items-stretch mx-auto'>
		<LinkComponent className='brand-card d-flex justify-content-center align-items-center p-4' to='/shop' onClick={ () => props.changeFilter(props.whichFilter) }>
