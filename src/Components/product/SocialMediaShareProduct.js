...
const SocialMediaShareProduct = ({ ...props }) => (
	<div>
		...
		<div className='d-flex justify-content-center'>
			<a className='mx-2' href={ `http://twitter.com/share?url=${ siteUrl }/${ props.shoeId }` } target='_blank'>
				<TwitterIcon size='lg' />
			</a>
			<a className='mx-2' href={ `http://facebook.com/sharer.php?u=${ siteUrl }/${ props.shoeId }` } target='_blank'>
